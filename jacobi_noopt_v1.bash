#!/bin/bash
#BSUB -J jacobi_noopt_v1_benchmark
#BSUB -o jacobi_noopt_v1_benchmark_%j.out
#BSUB -q hpcintro
#BSUB -n 24
...
# Output file
OUTPUT_FILE="jacobi_noopt_results_v1.data"
...
#         ./poisson_j $N 1000 1e-2 20 1  # Run parallel version (1)
#     done
# done
...
for T in "${THREADS[@]}"; do
    ...
    # Run the Jacobi solver and append results to file
    ./poisson_j 300 1000 1e-2 20 1 # Run parallel version (1)
done
